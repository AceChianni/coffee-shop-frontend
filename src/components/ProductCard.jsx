...
//   return (
//     <div className="card p-6 border border-neutral rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col h-full bg-base-100 text-base-content dark:bg-base-200 dark:border-base-300 dark:text-base-content">
//       <img
...
//         <p className="text-secondary mb-4 dark:text-base-content">{product.description}</p>
...
export default function ProductCard({ product, handleAddToCart }) {
  return (
    <div className="card p-6 border border-neutral rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col h-full bg-base-100 dark:bg-base-dark text-base-content dark:text-base-content-dark">
      ...
      />
      <div className="flex flex-col flex-grow">
        <h3 className="text-xl font-semibold text-primary dark:text-accent">{product.name}</h3>
